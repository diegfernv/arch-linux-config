...
alias run-stable-diffusion="~/Documents/PythonProjects/Stable\ Diffusion\ WebUI/ && conda activate sd-env && export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/diego/miniconda3/envs/sd-env/lib/ && if ! mount | grep -q '/dev/sda2'; then udisksctl mount -b /dev/sda2; fi && ./webui.sh --disable-safe-unpickle"
...
__conda_setup="$('/home/diego/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
export MAMBA_EXE='/home/diego/.local/bin/micromamba';
export MAMBA_ROOT_PREFIX='/home/diego/micromamba';
